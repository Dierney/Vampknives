...
namespace VampKnives.Projectiles
{
    public class LightandDarkProj : KnifeProjectile
    {
        ...
        //    int DustID2 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width - 3, projectile.height - 3, 70, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 10, Color.Purple, 1f);
