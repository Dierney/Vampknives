...
namespace VampKnives.Projectiles
{
	public class JungleKnivesProj : KnifeProjectile
	{
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            n.AddBuff(mod.BuffType("PenetratingPoison"), 300); //confused 2
            int healamnt = (int)(projectile.damage * .025);
            if(healamnt >= 1)
            {
                ...
                owner.statLife += healamnt; //Gives 2.5% of the damage dealt
                owner.HealEffect(healamnt, true);
            }
            Hoods(n);
        }
