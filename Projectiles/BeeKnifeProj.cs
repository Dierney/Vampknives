...
namespace VampKnives.Projectiles
{
	public class BeeKnifeProj : KnifeProjectile
	{
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            {
                Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, 181, 1, projectile.knockBack, Main.myPlayer);
            }
        ...
        {
            int ran1 = Main.rand.Next(-10, 10);
            int ran2 = Main.rand.Next(-10, 10);
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, ran1, ran2, 181, 1, projectile.knockBack, Main.myPlayer);
            return true;
        }
