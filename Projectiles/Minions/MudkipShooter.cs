...
{
	public abstract class MudkipShooter : Minion
	{
					...
					if (projectile.ai[1] == 0f)
					{
						...
						if (Main.myPlayer == projectile.owner)
						{
                            ...
                            for (int ab = 0; ab <= 50; ab++)
                            {
                                ...
                                int proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y + random, shootVel.X, shootVel.Y, shoot, 20, projectile.knockBack, Main.myPlayer, 0f, 0f);
