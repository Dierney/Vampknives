...
{
	public abstract class LucarioShooter : Minion
	{
				...
				if (target)
				{
					...
					if (projectile.ai[1] == 0f)
					{
						...
						if (Main.myPlayer == projectile.owner)
						{
							...
							shootVel.Normalize();
							shootVel *= shootSpeed;
							int proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, shootVel.X, shootVel.Y, shoot, 8, projectile.knockBack, Main.myPlayer, 0f, 0f);
