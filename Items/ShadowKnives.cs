...
namespace VampKnives.Items
{
    public class ShadowKnives : KnifeItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.noMelee = true;
            item.knockBack = 3;
            item.value = 10800; //10000 = 1 gold, 100 silver, or 10000 copper
        ...
        public override void AddRecipes()
        {
            ...
            recipe2.AddIngredient(mod.GetItem("ButchersKnives"), 1);
            recipe2.AddIngredient(mod.GetItem("FieryKnives"), 1);
            recipe2.AddIngredient(mod.GetItem("JungleKnives"), 1);
            recipe2.AddIngredient(mod.GetItem("SengosForgottenBlades"), 1);
