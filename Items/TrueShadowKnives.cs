...
namespace VampKnives.Items
{
    public class TrueShadowKnives : KnifeItem
    {
        ...
        {
            item.damage = 45; //PUT DAMAGE, GENERALLY 1/2 OF COMPONENT'S DAMAGE
            item.ranged = true;
            item.width = 38;
            item.height = 38;
            item.useTime = 15;
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("TrueShadowProj");
            item.shootSpeed = 15f;
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(mod.GetItem("ShadowKnives"));
