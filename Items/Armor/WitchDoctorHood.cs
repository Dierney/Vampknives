...
namespace VampKnives.Items.Armor
{
    ...
    public class WitchDoctorHood : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Witch Doctor's Hood");
            Tooltip.SetDefault("Imbues the user's knives with the powers of voodoo");
        }
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            p.WitchDoctorAccessory = true;
            p.WitchDoctor = true;
            if (hideVisual)
            {
                p.WitchDoctorHideVanity = true;
            }
        }
    }

    public class WitchDoctorHead : EquipTexture
    {
