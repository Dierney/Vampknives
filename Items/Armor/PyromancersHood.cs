...
namespace VampKnives.Items.Armor
{
    ...
    public class PyromancersHood : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Pyromancer's Hood");
            Tooltip.SetDefault("Imbues the user's knives with fire");
        }
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            p.pyroAccessory = true;
            p.pyro = true;
            if (hideVisual)
            {
                p.pyroHideVanity = true;
            }
        }
    }

    public class PyroHead : EquipTexture
    {
